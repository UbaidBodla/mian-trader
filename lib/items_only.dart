...
class ItemsOnly extends StatefulWidget {
  static String id='ItemsOnly';
  @override
  _ItemsOnlyState createState() => _ItemsOnlyState();
}

class _ItemsOnlyState extends State<ItemsOnly> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: _firestore.collection('items').orderBy('A').snapshots(),
        builder: (context, snapshot){
          ...
          for(var categori in categories){
            ...
            final catB=categori.data['B'];
            final catC=categori.data['C'];
